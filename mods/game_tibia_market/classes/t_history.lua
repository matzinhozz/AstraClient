...
function MarketHistory.onParseMarketHistory(buyOffers, sellOffers)
	...
	sellScrollbar.onValueChange = function(self, value, delta) MarketHistory.onTopListValueChange(self, value, delta) end
	...
	buyScrollbar.onValueChange = function(self, value, delta) MarketHistory.onBottomListValueChange(self, value, delta) end

	window.sellOffersList.onChildFocusChange = function(self, selected) MarketHistory.onSelectHistoryChild(self, selected, true) end
	window.buyOffersList.onChildFocusChange = function(self, selected) MarketHistory.onSelectHistoryChild(self, selected, false) end
