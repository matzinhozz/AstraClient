...
void main()
{
    ...
    // Alternando entre a cor original e branco-meio-cinza
    vec4 color = texColor; // Mantém a cor original durante intervalos ímpares
    if (isBlinkInterval) {
        color = vec4(0.8, 0.8, 0.8, texColor.a); // Branco-meio-cinza durante intervalos pares
    }
